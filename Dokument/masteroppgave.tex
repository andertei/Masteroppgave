...
\item The interruption test results for geometry \textbf{c} fits well with previously tested geometries. If compared to the previously tested geometry \textbf{d} the interruption results are equal in the 630 A test. When testing at 880 A on geometry \textbf{c}, the upstream over-pressure needed to obtain a 50\% interruption success rate dropped from 0.52 bar to 0.425 bar giving a decrease of 18\%, when increasing the contact area with 40\%, from 28.3 mm$^2$ to 39.6 mm$^2$, compared to geometry \textbf{d}.
