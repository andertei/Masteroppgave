...
\section{Conclusion} %and suggestions for further work
...
\item  A Rogowski coil might be applied to measure the current more accurate during the CZ and re-ignition. This might reveal more of the post-arc current, as well as better describe the current after a dielectric re-ignition.
\end{itemize}
