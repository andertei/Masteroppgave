...
\newpage
\subsection{Dielectric re-ignition} \label{sec:dielectricReIgnitionResults}

\begin{figure}[H]
\centering
\includegraphics[scale=0.7]{Bilder/Results/DRplot_calc.png}
\caption{Current and voltage waveforms near CZ for a dielectric re-ignition.} \label{fig:DR_disc_example}
\end{figure}
