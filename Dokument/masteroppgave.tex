...
Then the increase in arcing voltage per millimetre is calculated. Linear regression when the arc is between 23.2 mm and 38.8 mm is used to establish the increase per length in the arcing voltage, and thereby the increase in arcing voltage caused by elongation of the arc can be established. The increase per length was then calculated to be 2.7 V$/$mm in absolute value.
