...
Another phenomena observed for geometry \textbf{a} and \textbf{b} was how the air was dispersed around the arc. In figure \ref{fig:funnelDisp}, two 630 A interruption tests, the upper one for geometry \textbf{b} and the lower one for geometry \textbf{c} is displayed. Both pictures is taken with approximately the same positioning of the pin and current magnitude, as well as the same upstream over-pressure of 0.3 bar. It is possible that this difference in air dispersion increases the cooling efficiency, resulting in the good interruption rate observed for geometry \textbf{a} and \textbf{b}.
