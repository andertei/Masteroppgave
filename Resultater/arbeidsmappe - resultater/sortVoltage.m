...
%fflush(stdout);
test_ONE=load('075_pos14_TR_Ok.lvm');
test_TWO=load('114_pos23_TR_OK.lvm');
test_THREE=load('114_pos23_TR_OK.lvm');
test_FOUR=load('118_pos25_TR_OK.lvm');
test_FIVE=load('126_pos18_TR_OK.lvm');
